...
public:
  ...
  bool calcCameraInitinRealWorld();
  ...
  double _first_lidar_time = 0.0, _first_imu_time = -1.0;
  ...
  int img_en = 1, img_down = 1, imu_int_frame = 3;
  bool normal_en = true;
  bool exposure_estimate_en = false;
  double exposure_time_init = 0.0;
  bool inverse_composition_en = false;
  bool raycast_en = false;
  int lidar_en = 1, real_camera_init_en = 0;
  ...
  vector<double> extrinT_I2B;
  vector<double> extrinR_I2B;
