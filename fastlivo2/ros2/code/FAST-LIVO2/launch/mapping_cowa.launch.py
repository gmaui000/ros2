...
def generate_launch_description():
    ...
    #Load parameters
    avia_config_cmd = os.path.join(config_file_dir, "rs_helios.yaml")
    camera_config_cmd = os.path.join(config_file_dir, "camera_stereo.yaml")
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            remappings=[
                ("in/compressed",  "/front/ch1/stereo"),
                ("out", "/front/ch1/image")
                # ("in/compressed",  "/camera3"),
                # ("out", "/camera3/image")
            ],
            output="screen",
            respawn=use_respawn,
