...
#define MV_MODULE_LONG_NAME "MV LightController PCIe Devices"
#define MV_COMPANY          "MVFG"
#define MV_COPYRIGHT        "GPL"
#define MV_VERSION          "1.0.0.3 build 20250806"

#define MV_CLASS_NAME       "mvfglc_class"
#define MV_DEVICE_NAME      "mvfglc"

//根据设备的id填写,厂商id和设备id

#define LC_VENDOR_ID            0x10ee
#define LC_DEVICE_ID            0x1028
#define LC_SUBSYSTEM_ID         0x1128
...
typedef struct _PCI_DEVICE_
{
    ...
    char                            chLcClassName[20];
    char                            chLcDeviceName[20];
...
extern int MV_AddDevice(void* pPciDevice, char* chDeviceName, char* chLcClassName);
