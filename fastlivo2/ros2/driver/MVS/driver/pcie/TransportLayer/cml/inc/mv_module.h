...
#define MV_MODULE_LONG_NAME "MVFG Dual Cameralink Frame Grabber"
#define MV_COMPANY          "MVFG"
#define MV_COPYRIGHT        "GPL"
#define MV_VERSION          "2.6.1.3 build 20250806"

#define MV_CLASS_NAME       "mvfgcml_class"
#define MV_DEVICE_NAME      "mvfgcml"
...
typedef struct _PCI_DEVICE_
{
    ...
    char                            chCmlClassName[20];
    char                            chCmlDeviceName[20];
...
extern int MV_AddDevice(void* pPciDevice, char* chDeviceName, char* chCmlClassName);
