...
#define MV_VERSION          "2.6.1.3 build 20250806"

#define MV_CLASS_NAME       "mvfgxof_class"
#define MV_DEVICE_NAME      "mvfgxof"

//根据设备的id填写,厂商id和设备id

#define XOF_VENDOR_ID      0x10ee

//GS-1002F
#define XOF_DEVICE_ID                0x7028
#define XOF_SUBDEVICE_ID             0x8627

#define XOF_GS1002F_V3_DEVICE_ID     0x8034
#define XOF_GS1002F_V3_SUBDEVICE_ID  0x8627

#define XOF_GS1004F_DEVICE_ID        0x7028
#define XOF_GS1004F_SUBDEVICE_ID     0x8647

#define XOF_GS1004F_V3_DEVICE_ID     0x8034
#define XOF_GS1004F_V3_SUBDEVICE_ID  0x8647

#define XOF_GS1104F_DEVICE_ID        0x8038
#define XOF_GS1104F_SUBDEVICE_ID     0x8647

#define XOF_GQ1001_DEVICE_ID         0x8038
#define XOF_GQ1001_SUBDEVICE_ID      0X8787

#define XOF_GQ1001_NEW_DEVICE_ID     0x8038
#define XOF_GQ1001_NEW_SUBDEVICE_ID  0x8747

#define XOF_GQ1202_DEVICE_ID         0x9048
#define XOF_GQ1202_SUBDEVICE_ID      0x8887
...
typedef struct _DEVICE_DATA_
{
    ...
    int                     hMSInterrupt[MSI_COUNT];                // 中断对象数组
...
extern int ModuleSuspend(struct pci_dev *dev, pm_message_t state);
extern int ModuleResume(struct pci_dev *dev);
...
extern int MV_ModuleSuspend(void* pPciDevice, void* pDriverData);
extern int MV_ModuleResume(void* pPciDevice, void* pDriverData);
...
extern int MV_RequestIrq(void* pPciDevice, irqreturn_t (*interruptfn)(int nIrq, void *pData), void* pDriverData);
...
extern void MV_ReadIDPci(void* pPciDevice, unsigned int* nVendor, unsigned int* nDeviceID, unsigned int* nSubsystemVendorID, unsigned int* nSubsystemDeviceID);
